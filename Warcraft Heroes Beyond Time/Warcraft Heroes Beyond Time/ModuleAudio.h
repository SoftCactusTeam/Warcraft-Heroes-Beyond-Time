...
public:
	...
	uint Thrall_Hit1_FX = 0u;
	uint Thrall_Hit2_FX = 0u;
	uint Thrall_Hit3_FX = 0u;
	uint Thrall_Hitted_FX = 0u;
	uint Thrall_EnergyMax_FX = 0u;
	uint Thrall_Attack_1_FX = 0u;
	uint Thrall_Attack_2_FX = 0u;
	uint Thrall_Attack_3_FX = 0u;
	...
	uint Selection_Fx = 0u;
	uint Sipin_bye_FX = 0u;
	uint Sipin_hello_FX = 0u;
